...
func BenchmarkEncrypt(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		Encrypt([]byte("hello, world"), []byte{}, bob)
	}
}
...
func BenchmarkDecrypt(b *testing.B) {
	...
	enc, _ := Encrypt(key, []byte{}, msg)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Decrypt(key, salt, enc)
	}
}
